...
3. [What To Do After Setup](/en/guide/after-setup)
4. [Channels](/en/guide/channels)
5. [Tutorials](/en/guide/tutorials)
6. [Resource Hub](/en/guide/resources)

## Advanced capabilities

If you need config files, secret refs, or workspace templates, see [Advanced Configuration](/en/guide/advanced).
